  ...
  function calcular(){
    ...
    */
    var curp = generaCurp({
      ...
      apellido_materno  : 'valerio',
      sexo              : 'M',
      estado            : 'OC',
      fecha_nacimiento  : [24, 01, 1968]
    });
    document.getElementById("la_curp").value = curp;
  }
...
<body>
  ...
  <input type="text" id="ap_paterno" placeholder="AP_PATERNO"><br>
  <input type="text" id="ap_materno" placeholder="AP_MATERNO"><br>
  <input type="text" name="nombre" id="nombre" placeholder="NOMBRE">
<button onclick="calcular()">Generar curp</button>    


<input type="text" name="la_curp" id="la_curp">
</body>
</html>
